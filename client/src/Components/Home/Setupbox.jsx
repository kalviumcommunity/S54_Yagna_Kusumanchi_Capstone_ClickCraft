        ...
        <Box bg="#010314" display="flex" flexDirection="column" justifyContent="center" alignItems="center" color="white" >
            ...
            <Box sx={BoxStyle} w="80vw" bg={"#010314"} display={"flex"} justifyContent="spaceBetween" alignItems="center" mt={10}>
                ...
                <Box mx={10} mr={20}>
                    ...
                    <Text color="#77798F" mt={5} maxW="600px" fontSize="1.4em">Just share your details, choose a template, and see your personal portfolio magically appear. Confirm or make any changes you like, and  Grab a special link to share your portfolio with everyone. Boost your online presence the easy way!</Text>
                    <Button bg="#010314"
                        size="lg"
                        color="white"
